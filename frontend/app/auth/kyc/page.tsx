...
import { 
  ...
  User, CheckCircle2, ArrowLeft, Loader2 
} from 'lucide-react';
...
export default function UserKycDashboard() {
  ...
  return (
    <main className="min-h-screen bg-space text-white py-12 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        
        {/* Back navigation */}
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="p-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Upgrade your credentials to increase package matches and trust scores.</p>
          </div>
        </div>
            ...
            {kycData?.kycStatus === 'APPROVED' ? (
              ...
              <form onSubmit={handleKycSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border border-dashed border-white/10 rounded-xl p-4 text-center cursor-pointer hover:bg-white/5 transition-all">
                    <input 
                      type="file" 
                      accept="image/*"
